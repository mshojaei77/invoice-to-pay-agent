...
class APGraphState(TypedDict):
    ...
    invoice_capture_plan: NotRequired[dict[str, Any]]
    gl_coding_result: NotRequired[dict[str, Any]]
    fraud_result: NotRequired[dict[str, Any]]
    ...
    line_approval_plan: NotRequired[dict[str, Any]]
    ledger_visibility_plan: NotRequired[dict[str, Any]]
    po_lifecycle_plan: NotRequired[dict[str, Any]]
    netsuite_ap_readiness: NotRequired[dict[str, Any]]
    order_to_cash_plan: NotRequired[dict[str, Any]]
    accrual_close_plan: NotRequired[dict[str, Any]]
    spend_intelligence: NotRequired[dict[str, Any]]
    billing_revenue_plan: NotRequired[dict[str, Any]]
    einvoicing_compliance_plan: NotRequired[dict[str, Any]]
    compliance_result: NotRequired[dict[str, Any]]
    payment_plan: NotRequired[dict[str, Any]]
    payment_execution_plan: NotRequired[dict[str, Any]]
    vendor_relationship_plan: NotRequired[dict[str, Any]]
    realtime_ap_visibility: NotRequired[dict[str, Any]]
    ap_agent_orchestration: NotRequired[dict[str, Any]]
