...
def build_graph():
    ...
    builder.add_node("invoice_capture_planning", invoice_capture_planning)
    ...
    builder.add_node("fraud_detection_check", fraud_detection_check)
    ...
    builder.add_node("payment_execution_planning", payment_execution_planning)
    builder.add_node("vendor_relationship_planning", vendor_relationship_planning)
    ...
    builder.add_node("realtime_ap_visibility_snapshot", realtime_ap_visibility_snapshot)
    ...
    builder.add_node("ap_agent_orchestration_planning", ap_agent_orchestration_planning)
    ...
    builder.add_edge("classify_ap_exceptions", "invoice_capture_planning")
    builder.add_edge("invoice_capture_planning", "suggest_gl_coding")
    ...
    builder.add_edge("risk_score", "fraud_detection_check")
    builder.add_edge("fraud_detection_check", "approval_routing")
    ...
    builder.add_edge("ledger_visibility_planning", "payment_execution_planning")
    builder.add_edge("payment_execution_planning", "vendor_relationship_planning")
    builder.add_edge("vendor_relationship_planning", "netsuite_ap_readiness_check")
    ...
    builder.add_edge("spend_intelligence_analysis", "realtime_ap_visibility_snapshot")
    builder.add_edge("realtime_ap_visibility_snapshot", "billing_revenue_planning")
    ...
    builder.add_edge("finance_agent_planning", "ap_agent_orchestration_planning")
    builder.add_edge("ap_agent_orchestration_planning", "ai_governance_check")
